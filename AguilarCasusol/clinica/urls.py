...
from .views import (
    home,
    documentoList,documentoCreate,documentoUpdate,documentoDelete,
    seguroCreate,seguroList,seguroUpdate,seguroDelete,pacienteList,
    pacienteCreate,pacienteUpdate,pacienteDelete,especialidadesList,
    especialidadesCreate,especialidadesUpdate,especialidadesDelete,
    doctorList,doctorCreate,doctorUpdate,doctorDelete,citasList,
    citasCreate,citasUpdate,citasDelete,usuarioList,usuarioUpdate,
)
